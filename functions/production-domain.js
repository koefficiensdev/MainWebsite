...
function build(order,input={}) {
  ...
  if((order.itemIds||[]).some(id=>['website-shop','website-pro','website-business','website-onepage'].includes(id)))missing.push('A kiválasztott csomag további oldalainak, üzleti moduljának vagy webshopjának egyedi specifikációja és megvalósítása');
