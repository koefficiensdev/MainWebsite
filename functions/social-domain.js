...
function mediaUrl(value){try{const u=new URL(value);return u.protocol==='https:'&&['media.zernio.com','media.getlate.dev'].includes(u.hostname)?u.href:null;}catch{return null;}}
...
module.exports={PLATFORMS,id,metadata,video,creatorCheck,payload,fingerprint,publicPost,mediaUrl,analytics,fail};
