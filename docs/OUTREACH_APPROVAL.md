...
A `no_website` kutatás a támogatott helyi szakmáknál először nyilvános OpenStreetMap üzleti adatokból gyűjt olyan jelölteket, amelyeknél közzétett e-mail-cím van, de saját weboldal nincs feltüntetve. Az admin böngészője végzi ezt az előkeresést, mert a nyilvános Overpass-példányok a felhős kiszolgálók forgalmát időnként korlátozzák; ha nincs böngészős találat, a szerver legfeljebb hét napos privát gyorsítótárból indul, majd maga is megpróbálja a frissítést. Minden sikeres friss lekérés megújítja a privát gyorsítótárat. Csak az engedélyezett OpenStreetMap-rekord URL-je, érvényes e-mail, név és rövid leírás kerülhet át a szerverre. Az AI ezután a pontos cégnévre keresve ellenőrzi, hogy található-e önálló hivatalos honlap, megszűnt-e a vállalkozás, illetve egyértelmű-e az azonosság. A térképes adat önmagában nem bizonyítja a honlap hiányát; csak olcsó és célzott jelöltforrás. A felület minden ilyen rekordnál megjeleníti az OpenStreetMap-forrást és az előírt szerzői hivatkozást. A lekérdezés a nyilvánosan dokumentált FOSSGIS és Private.coffee Overpass-példányok között automatikusan átvált, mert az ingyenes példányok időnként túlterheltek lehetnek.
