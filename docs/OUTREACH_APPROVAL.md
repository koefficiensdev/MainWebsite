...
Admin → Hirdető e-mailek → Küldésre kész: minden új, minősített kártyán külön „Jóváhagyom és elküldöm ezt a levelet” gomb. Az ellenőrzött megkeresési alap, a bizonyítékleírás és a végső címzett-összefoglaló továbbra is kötelező. Kijelöléssel csoportosan is jóváhagyható legfeljebb 10 levél. A Leadek nézet új jelöltjein a „Levél és küldés” gomb ide vezet.
...
Jóváhagyás és elküldés → a megerősítés felsorolja a címzetteket és tárgyakat → szerveroldali ellenőrzés → SMTP. Egy körben maximum 10 levél. A szolgáltató átvétele nem kézbesítési vagy olvasási igazolás. Jóváhagyáskor rögzül az admin UID, időpont, teljes tartalom hash-e és a megkeresési alap.
...
- Napi legfeljebb 100 küldési kísérlet Budapest időzónában. Címzettenként és céges e-mail-domainenként egyszeri hideg megkeresés; nincs automatikus follow-up.
...
- Leiratkozás: manuális tiltás gomb vagy explicit LEIRATKOZAS / unsubscribe válasz. Bármilyen emberi válasz további hideg megkeresés ellen tiltást tesz, amíg ember egyeztet. Más megfogalmazású törlési / tiltási kéréseket kézzel kell kezelni. A tiltási rekord hash-alapú.
...
- SPF rekord megvan; DMARC rekord a 2026-08-31-i DNS-ellenőrzéskor hiányzik, DKIM nincs ellenőrizve. Nagyobb volumen előtt kézbesíthetőségi ellenőrzés és próbaküldés szükséges; a napi 100 technikai maximum, nem kézbesítési ígéret.
